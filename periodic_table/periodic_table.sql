...
--
-- Name: properties propfk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT propfk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number) MATCH FULL;


--
-- Name: properties typefk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT typefk FOREIGN KEY (type_id) REFERENCES public.types(type_id) MATCH FULL;
